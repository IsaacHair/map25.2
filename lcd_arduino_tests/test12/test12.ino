...
// output bit 0 (lsb) is inverted; all others are value
//
...
// 1st Parameter - Dummy byte could be anything
 ...
 // 4th Parameter should be 41h     
  ...
  digitalWrite(CS, 0);
  digitalWrite(CD, 0);
  digitalWrite(D0, 1); digitalWrite(D1, 0); digitalWrite(D2, 0); digitalWrite(D3, 1);  // 8 - Change for lower nibble as required
  ...
  //digitalWrite(CS, 0);
  //digitalWrite(CD, 0);
  digitalWrite(D0, 0); digitalWrite(D1, 0); digitalWrite(D2, 0); digitalWrite(D3, 0);  // 1 - Change for lower nibble as required
  ...
  //digitalWrite(CS, 0);
  //digitalWrite(CD, 0);
  digitalWrite(D0, 0); digitalWrite(D1, 1); digitalWrite(D2, 0); digitalWrite(D3, 0);  // 3 - Change for lower nibble as required
  digitalWrite(D4, 1); digitalWrite(D5, 0); digitalWrite(D6, 0); digitalWrite(D7, 0);  // 1 - Change for upper nibble as required
  digitalWrite(WR, 0); digitalWrite(WR, 1);
  //digitalWrite(CD, 1);
  //digitalWrite(CS, 1);
  ...
  //digitalWrite(CS, 0);
  //digitalWrite(CD, 0);
  digitalWrite(D0, 1); digitalWrite(D1, 0); digitalWrite(D2, 1); digitalWrite(D3, 1);  // C - Change for lower nibble as required
  digitalWrite(D4, 0); digitalWrite(D5, 0); digitalWrite(D6, 0); digitalWrite(D7, 0);  // 0 - Change for upper nibble as required
  digitalWrite(WR, 0); digitalWrite(WR, 1);
  digitalWrite(CD, 1);
  digitalWrite(D0, 1); digitalWrite(D1, 1); digitalWrite(D2, 1); digitalWrite(D3, 0);  // 5 - Change for lower nibble as required
  ...
  //digitalWrite(CS, 0);
  digitalWrite(CD, 0);
  digitalWrite(D0, 1); digitalWrite(D1, 0); digitalWrite(D2, 0); digitalWrite(D3, 0);  // 0 - Change for lower nibble as required
  ...
  //digitalWrite(CS, 0);
  //digitalWrite(CD, 0);
  digitalWrite(D0, 1); digitalWrite(D1, 1); digitalWrite(D2, 0); digitalWrite(D3, 1);  // A - Change for lower nibble as required
  digitalWrite(D4, 0); digitalWrite(D5, 1); digitalWrite(D6, 0); digitalWrite(D7, 0);  // 2 - Change for upper nibble as required
  digitalWrite(WR, 0); digitalWrite(WR, 1);
  digitalWrite(CD, 1);
  digitalWrite(D0, 1); digitalWrite(D1, 0); digitalWrite(D2, 0); digitalWrite(D3, 0);  // 0 - Change for lower nibble as required
  ...
  digitalWrite(D4, 0); digitalWrite(D5, 0); digitalWrite(D6, 0); digitalWrite(D7, 0);  // 0 - Change for upper nibble as required
  digitalWrite(WR, 0); digitalWrite(WR, 1);
  digitalWrite(D0, 0); digitalWrite(D1, 1); digitalWrite(D2, 1); digitalWrite(D3, 1);  // f - Change for lower nibble as required
  digitalWrite(D4, 0); digitalWrite(D5, 1); digitalWrite(D6, 1); digitalWrite(D7, 1);  // e - Change for upper nibble as required
  digitalWrite(WR, 0); digitalWrite(WR, 1);
  //digitalWrite(CS, 1);
  ...
  //digitalWrite(CS, 0);
  digitalWrite(CD, 0);
  digitalWrite(D0, 0); digitalWrite(D1, 1); digitalWrite(D2, 0); digitalWrite(D3, 1);  // B - Change for lower nibble as required
  digitalWrite(D4, 0); digitalWrite(D5, 1); digitalWrite(D6, 0); digitalWrite(D7, 0);  // 2 - Change for upper nibble as required
  digitalWrite(WR, 0); digitalWrite(WR, 1);
  digitalWrite(CD, 1);
  digitalWrite(D0, 1); digitalWrite(D1, 0); digitalWrite(D2, 0); digitalWrite(D3, 0);  // 0 - Change for lower nibble as required
