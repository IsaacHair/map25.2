...
#define _KEY_C1 0x8000 //output (thru a 1kohm resistor)
#define _KEY_C2 0x4000 //output (thru a 1kohm resistor)
#define _KEY_C3 0x2000 //output (thru a 1kohm resistor)
