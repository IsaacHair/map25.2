...
03b5 addr jzor ffff 03b6
03b6 dnc noop 0000 03b8
03b7 dnc noop 0000 036d
03b8 imm out0 0400 03b9
03b9 imm out0 00ff 03ba
03ba imm out1 0000 03bb
03bb imm out0 0200 03bc
03bc imm out1 0200 03bd
03bd imm out0 0400 03be
03be imm out0 00ff 03bf
03bf imm out1 0000 03c0
03c0 imm out0 0200 03c1
03c1 imm out1 0200 03c2
03c2 imm out0 0400 03c3
03c3 imm out0 00ff 03c4
03c4 imm out1 002a 03c5
03c5 imm out0 0200 03c6
03c6 imm out1 0200 03c7
03c7 imm out1 0400 03c8
03c8 imm addr0 ffff 03c9
03c9 imm addr1 0008 03ca
03ca imm gen0 ffff 03cb
03cb ram jzor 0100 03cc
03cc dnc noop 0000 03ce
03cd imm gen1 0001 03ce
03ce imm out0 00ff 03cf
03cf imm gen0 ff00 03d0
03d0 gen out1 0000 03d1
03d1 imm out0 0200 03d2
03d2 imm out1 0200 03d3
03d3 imm addr0 ffff 03d4
03d4 imm addr1 0008 03d5
03d5 imm gen0 ffff 03d6
03d6 ram gen1 0000 03d7
03d7 imm out0 00ff 03d8
03d8 imm gen0 ff00 03d9
03d9 gen out1 0000 03da
03da imm out0 0200 03db
03db imm out1 0200 03dc
03dc imm addr0 ffff 03dd
03dd imm addr1 000e 03de
03de imm gen0 ffff 03df
03df ram jzor 0100 03e0
03e0 dnc noop 0000 03e2
03e1 imm gen1 0001 03e2
03e2 imm out0 00ff 03e3
03e3 imm gen0 ff00 03e4
03e4 gen out1 0000 03e5
03e5 imm out0 0200 03e6
03e6 imm out1 0200 03e7
03e7 imm addr0 ffff 03e8
03e8 imm addr1 000e 03e9
03e9 imm gen0 ffff 03ea
03ea ram gen1 0000 03eb
03eb imm out0 00ff 03ec
03ec imm gen0 ff00 03ed
03ed gen out1 0000 03ee
03ee imm out0 0200 03ef
03ef imm out1 0200 03f0
03f0 imm out0 0400 03f1
03f1 imm out0 00ff 03f2
03f2 imm out1 002b 03f3
03f3 imm out0 0200 03f4
03f4 imm out1 0200 03f5
03f5 imm out1 0400 03f6
03f6 imm addr0 ffff 03f7
03f7 imm addr1 0009 03f8
03f8 imm gen0 ffff 03f9
03f9 ram jzor 0100 03fa
03fa dnc noop 0000 03fc
03fb imm gen1 0001 03fc
03fc imm out0 00ff 03fd
03fd imm gen0 ff00 03fe
03fe gen out1 0000 03ff
03ff imm out0 0200 0400
0400 imm out1 0200 0401
0401 imm addr0 ffff 0402
0402 imm addr1 0009 0403
0403 imm gen0 ffff 0404
0404 ram gen1 0000 0405
0405 imm out0 00ff 0406
0406 imm gen0 ff00 0407
0407 gen out1 0000 0408
0408 imm out0 0200 0409
0409 imm out1 0200 040a
040a imm addr0 ffff 040b
040b imm addr1 000f 040c
040c imm gen0 ffff 040d
040d ram jzor 0100 040e
040e dnc noop 0000 0410
040f imm gen1 0001 0410
0410 imm out0 00ff 0411
0411 imm gen0 ff00 0412
0412 gen out1 0000 0413
0413 imm out0 0200 0414
0414 imm out1 0200 0415
0415 imm addr0 ffff 0416
0416 imm addr1 000f 0417
0417 imm gen0 ffff 0418
0418 ram gen1 0000 0419
0419 imm out0 00ff 041a
041a imm gen0 ff00 041b
041b gen out1 0000 041c
041c imm out0 0200 041d
041d imm out1 0200 041e
041e imm out0 0400 041f
041f imm out0 00ff 0420
0420 imm out1 002c 0421
0421 imm out0 0200 0422
0422 imm out1 0200 0423
0423 imm out1 0400 0424
0424 imm addr0 ffff 0425
0425 imm addr1 0032 0427
0427 addr jzor 00ff 0428
0428 addr jzor 0fff 042a
0429 addr jzor 000f 042c
042a addr jzor 3fff 042e
042b addr jzor 03ff 0430
042c addr jzor 003f 0432
042d addr jzor 0003 0434
042e addr jzor 7fff 0436
042f addr jzor 1fff 0438
0430 addr jzor 07ff 043a
0431 addr jzor 01ff 043c
0432 addr jzor 007f 043e
0433 addr jzor 001f 0440
0434 addr jzor 0007 0442
0435 addr jzor 0001 0444
0436 addr jzor ffff 0446
0437 imm addr1 3fff 0449
0438 imm addr1 1fff 044a
0439 imm addr1 0fff 044b
043a imm addr1 07ff 044c
043b imm addr1 03ff 044d
043c imm addr1 01ff 044e
043d imm addr1 00ff 044f
043e imm addr1 007f 0450
043f imm addr1 003f 0451
0440 imm addr1 001f 0452
0441 imm addr1 000f 0453
0442 imm addr1 0007 0454
0443 imm addr1 0003 0455
0444 imm addr1 0001 0456
0445 imm addr0 0001 0457
0446 imm addr1 ffff 0457
0447 imm addr1 7fff 0448
0448 imm addr0 8000 0457
0449 imm addr0 4000 0457
044a imm addr0 2000 0457
044b imm addr0 1000 0457
044c imm addr0 0800 0457
044d imm addr0 0400 0457
044e imm addr0 0200 0457
044f imm addr0 0100 0457
0450 imm addr0 0080 0457
0451 imm addr0 0040 0457
0452 imm addr0 0020 0457
0453 imm addr0 0010 0457
0454 imm addr0 0008 0457
0455 imm addr0 0004 0457
0456 imm addr0 0002 0457
0457 imm out0 00ff 0458
0458 imm out1 00fc 0459
0459 imm out0 0200 045a
045a imm out1 0200 045b
045b imm out0 00ff 045c
045c imm out1 00fc 045d
045d imm out0 0200 045e
045e imm out1 0200 045f
045f imm out0 00ff 0460
0460 imm out1 00fc 0461
0461 imm out0 0200 0462
0462 imm out1 0200 0463
0463 imm out0 00ff 0464
0464 imm out1 00fc 0465
0465 imm out0 0200 0466
0466 imm out1 0200 0467
0467 imm out0 00ff 0468
0468 imm out1 00fc 0469
0469 imm out0 0200 046a
046a imm out1 0200 046b
046b imm out0 00ff 046c
046c imm out1 00fc 046d
046d imm out0 0200 046e
046e imm out1 0200 046f
046f addr jzor ffff 0470
0470 dnc noop 0000 0472
0471 dnc noop 0000 0427
0472 imm out0 0400 0473
0473 imm out0 00ff 0474
0474 imm out1 0000 0475
0475 imm out0 0200 0476
0476 imm out1 0200 0477
0477 dnc noop 0000 01ef
0478 imm addr0 ffff 0479
0479 imm addr1 0000 047a
047a imm gen0 ffff 047b
047b ram gen1 0000 047c
047c imm addr0 ffff 047d
047d imm addr1 0001 047f
047f ram jzor 0001 0480
0480 gen jzor 0001 0482
0481 gen jzor 0001 0484
0482 ram jzor 0002 0490
0483 ram jzor 0002 0490
0484 imm gen1 0001 0486
0485 imm gen0 0001 0487
0486 ram jzor 0002 0490
0487 ram jzor 0002 0498
0488 gen jzor 0001 048a
0489 gen jzor 0001 048c
048a imm gen1 0001 048e
048b imm gen0 0001 048f
048c ram jzor 0002 0498
048d ram jzor 0002 0498
048e ram jzor 0002 0490
048f ram jzor 0002 0498
0490 gen jzor 0002 0492
0491 gen jzor 0002 0494
0492 ram jzor 0004 04a0
0493 ram jzor 0004 04a0
0494 imm gen1 0002 0496
0495 imm gen0 0002 0497
0496 ram jzor 0004 04a0
0497 ram jzor 0004 04a8
0498 gen jzor 0002 049a
0499 gen jzor 0002 049c
049a imm gen1 0002 049e
049b imm gen0 0002 049f
049c ram jzor 0004 04a8
049d ram jzor 0004 04a8
049e ram jzor 0004 04a0
049f ram jzor 0004 04a8
04a0 gen jzor 0004 04a2
04a1 gen jzor 0004 04a4
04a2 ram jzor 0008 04b0
04a3 ram jzor 0008 04b0
04a4 imm gen1 0004 04a6
04a5 imm gen0 0004 04a7
04a6 ram jzor 0008 04b0
04a7 ram jzor 0008 04b8
04a8 gen jzor 0004 04aa
04a9 gen jzor 0004 04ac
04aa imm gen1 0004 04ae
04ab imm gen0 0004 04af
04ac ram jzor 0008 04b8
04ad ram jzor 0008 04b8
04ae ram jzor 0008 04b0
04af ram jzor 0008 04b8
04b0 gen jzor 0008 04b2
04b1 gen jzor 0008 04b4
04b2 ram jzor 0010 04c0
04b3 ram jzor 0010 04c0
04b4 imm gen1 0008 04b6
04b5 imm gen0 0008 04b7
04b6 ram jzor 0010 04c0
04b7 ram jzor 0010 04c8
04b8 gen jzor 0008 04ba
04b9 gen jzor 0008 04bc
04ba imm gen1 0008 04be
04bb imm gen0 0008 04bf
04bc ram jzor 0010 04c8
04bd ram jzor 0010 04c8
04be ram jzor 0010 04c0
04bf ram jzor 0010 04c8
04c0 gen jzor 0010 04c2
04c1 gen jzor 0010 04c4
04c2 ram jzor 0020 04d0
04c3 ram jzor 0020 04d0
04c4 imm gen1 0010 04c6
04c5 imm gen0 0010 04c7
04c6 ram jzor 0020 04d0
04c7 ram jzor 0020 04d8
04c8 gen jzor 0010 04ca
04c9 gen jzor 0010 04cc
04ca imm gen1 0010 04ce
04cb imm gen0 0010 04cf
04cc ram jzor 0020 04d8
04cd ram jzor 0020 04d8
04ce ram jzor 0020 04d0
04cf ram jzor 0020 04d8
04d0 gen jzor 0020 04d2
04d1 gen jzor 0020 04d4
04d2 ram jzor 0040 04e0
04d3 ram jzor 0040 04e0
04d4 imm gen1 0020 04d6
04d5 imm gen0 0020 04d7
04d6 ram jzor 0040 04e0
04d7 ram jzor 0040 04e8
04d8 gen jzor 0020 04da
04d9 gen jzor 0020 04dc
04da imm gen1 0020 04de
04db imm gen0 0020 04df
04dc ram jzor 0040 04e8
04dd ram jzor 0040 04e8
04de ram jzor 0040 04e0
04df ram jzor 0040 04e8
04e0 gen jzor 0040 04e2
04e1 gen jzor 0040 04e4
04e2 ram jzor 0080 04f0
04e3 ram jzor 0080 04f0
04e4 imm gen1 0040 04e6
04e5 imm gen0 0040 04e7
04e6 ram jzor 0080 04f0
04e7 ram jzor 0080 04f8
04e8 gen jzor 0040 04ea
04e9 gen jzor 0040 04ec
04ea imm gen1 0040 04ee
04eb imm gen0 0040 04ef
04ec ram jzor 0080 04f8
04ed ram jzor 0080 04f8
04ee ram jzor 0080 04f0
04ef ram jzor 0080 04f8
04f0 gen jzor 0080 04f2
04f1 gen jzor 0080 04f4
04f2 ram jzor 0100 0500
04f3 ram jzor 0100 0500
04f4 imm gen1 0080 04f6
04f5 imm gen0 0080 04f7
04f6 ram jzor 0100 0500
04f7 ram jzor 0100 0508
04f8 gen jzor 0080 04fa
04f9 gen jzor 0080 04fc
04fa imm gen1 0080 04fe
04fb imm gen0 0080 04ff
04fc ram jzor 0100 0508
04fd ram jzor 0100 0508
04fe ram jzor 0100 0500
04ff ram jzor 0100 0508
0500 gen jzor 0100 0502
0501 gen jzor 0100 0504
0502 ram jzor 0200 0510
0503 ram jzor 0200 0510
0504 imm gen1 0100 0506
0505 imm gen0 0100 0507
0506 ram jzor 0200 0510
0507 ram jzor 0200 0518
0508 gen jzor 0100 050a
0509 gen jzor 0100 050c
050a imm gen1 0100 050e
050b imm gen0 0100 050f
050c ram jzor 0200 0518
050d ram jzor 0200 0518
050e ram jzor 0200 0510
050f ram jzor 0200 0518
0510 gen jzor 0200 0512
0511 gen jzor 0200 0514
0512 ram jzor 0400 0520
0513 ram jzor 0400 0520
0514 imm gen1 0200 0516
0515 imm gen0 0200 0517
0516 ram jzor 0400 0520
0517 ram jzor 0400 0528
0518 gen jzor 0200 051a
0519 gen jzor 0200 051c
051a imm gen1 0200 051e
051b imm gen0 0200 051f
051c ram jzor 0400 0528
051d ram jzor 0400 0528
051e ram jzor 0400 0520
051f ram jzor 0400 0528
0520 gen jzor 0400 0522
0521 gen jzor 0400 0524
0522 ram jzor 0800 0530
0523 ram jzor 0800 0530
0524 imm gen1 0400 0526
0525 imm gen0 0400 0527
0526 ram jzor 0800 0530
0527 ram jzor 0800 0538
0528 gen jzor 0400 052a
0529 gen jzor 0400 052c
052a imm gen1 0400 052e
052b imm gen0 0400 052f
052c ram jzor 0800 0538
052d ram jzor 0800 0538
052e ram jzor 0800 0530
052f ram jzor 0800 0538
0530 gen jzor 0800 0532
0531 gen jzor 0800 0534
0532 ram jzor 1000 0540
0533 ram jzor 1000 0540
0534 imm gen1 0800 0536
0535 imm gen0 0800 0537
0536 ram jzor 1000 0540
0537 ram jzor 1000 0548
0538 gen jzor 0800 053a
0539 gen jzor 0800 053c
053a imm gen1 0800 053e
053b imm gen0 0800 053f
053c ram jzor 1000 0548
053d ram jzor 1000 0548
053e ram jzor 1000 0540
053f ram jzor 1000 0548
0540 gen jzor 1000 0542
0541 gen jzor 1000 0544
0542 ram jzor 2000 0550
0543 ram jzor 2000 0550
0544 imm gen1 1000 0546
0545 imm gen0 1000 0547
0546 ram jzor 2000 0550
0547 ram jzor 2000 0558
0548 gen jzor 1000 054a
0549 gen jzor 1000 054c
054a imm gen1 1000 054e
054b imm gen0 1000 054f
054c ram jzor 2000 0558
054d ram jzor 2000 0558
054e ram jzor 2000 0550
054f ram jzor 2000 0558
0550 gen jzor 2000 0552
0551 gen jzor 2000 0554
0552 ram jzor 4000 0560
0553 ram jzor 4000 0560
0554 imm gen1 2000 0556
0555 imm gen0 2000 0557
0556 ram jzor 4000 0560
0557 ram jzor 4000 0568
0558 gen jzor 2000 055a
0559 gen jzor 2000 055c
055a imm gen1 2000 055e
055b imm gen0 2000 055f
055c ram jzor 4000 0568
055d ram jzor 4000 0568
055e ram jzor 4000 0560
055f ram jzor 4000 0568
0560 gen jzor 4000 0562
0561 gen jzor 4000 0564
0562 ram jzor 8000 0570
0563 ram jzor 8000 0570
0564 imm gen1 4000 0566
0565 imm gen0 4000 0567
0566 ram jzor 8000 0570
0567 ram jzor 8000 0576
0568 gen jzor 4000 056a
0569 gen jzor 4000 056c
056a imm gen1 4000 056e
056b imm gen0 4000 056f
056c ram jzor 8000 0576
056d ram jzor 8000 0576
056e ram jzor 8000 0570
056f ram jzor 8000 0576
0570 gen jzor 8000 0572
0571 gen jzor 8000 0574
0572 imm gen0 8000 057c
0573 imm gen1 8000 057c
0574 imm gen1 8000 057c
0575 imm gen0 8000 057c
0576 gen jzor 8000 0578
0577 gen jzor 8000 057a
0578 imm gen1 8000 057c
0579 imm gen0 8000 057c
057a imm gen0 8000 057c
057b imm gen1 8000 057c
057c imm addr0 ffff 057d
057d imm addr1 0002 057e
057e gen ramall 0000 057f
057f imm addr0 ffff 0580
0580 imm addr1 0003 0581
0581 ram asnx 0000 0582
