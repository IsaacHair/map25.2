...
#define VALUE_XSTART 0x1000
#define VALUE_DX 0xffe8
#define VALUE_XLIMN 0x0e00
#define VALUE_YSTART 0x0000
#define VALUE_DY 0x0018
#define VALUE_YLIMN 0xe980
...
void main(int argc, char**argv) {
	...
	inst("addr gen1 0000");
	buswritegen(); //blue
	//shift the rendering by *16 total
	//if >= 8, make medium green
	//if = 32, make it black
	//use addr as register helper
	//don't need to account for last bit wrap around
	inst("imm addr0 ffff");
