 ...
 * Note: If-else is constructed the lazy way by just guessing how long
 * the "if" segment should take and then pointing to like 2x that value.
 * An exact measure should be used instead.
 */
...
void main(int argc, char**argv) {
	...
	fd = fopen(argv[1], "w");
	addr = 0;
	unsigned short testloopaddr;

	testloopaddr = addr;
	inst("dnc noop 0000");
	genpred16();
	instnxt("dnc noop 0000", testloopaddr);
	
/*	inst("imm addr0 ffff");
	inst("imm addr1 0000");
	inst("imm ramall 9100");
	inst("imm addr0 ffff");
	inst("imm addr1 0001");
	inst("imm ramall 2800");
	callmul(2, 0, 1);
	inst("imm addr0 ffff");
	inst("imm addr1 0002");
	inst("imm out0 ffff");
	...
	inst("imm addr0 ffff");
	inst("imm addr1 0000");
	inst("imm ramall 33f0");
	inst("imm addr0 ffff");
	inst("imm addr1 0001");
	inst("imm ramall 0440");
	callmul(2, 0, 1);
	inst("imm addr0 ffff");
	inst("imm addr1 0002");
	inst("imm out0 ffff");
	...
	inst("imm addr0 ffff");
	inst("imm addr1 0000");
	inst("imm ramall bead");
	inst("imm addr0 ffff");
	inst("imm addr1 0001");
	inst("imm ramall face");
	callmul(2, 0, 1);
	inst("imm addr0 ffff");
	inst("imm addr1 0002");
	inst("imm out0 ffff");
