 ...
 *
 * For this version (v16):
 * This version has rings where overflow occurs, but I honestly think
 * it looks kinda cool and emphasizes the shape of the set. Plus,
 * this version has this highest precision possible with 16 bits.
 * The values of MAIN_ZI and MAIN_ZR are initiated to the values of
 * the MAIN_ZI0 and MAIN_ZR0 respectively (instead of 0x0000).
 */
