...
// 1st Parameter - Dummy byte could be anything
 ...
 // 4th Parameter should be 41h     
  ...
  // Start by writing to the command register with the command cause i think thats how this works
  digitalWrite(CD, 0);
  digitalWrite(CS, 0);
  digitalWrite(D0, 0); digitalWrite(D1, 1); digitalWrite(D2, 0); digitalWrite(D3, 0);  // 2 - Change for lower nibble as required
